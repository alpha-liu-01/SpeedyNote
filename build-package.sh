...
get_build_dependencies() {
    ...
    case $format in
        deb)
            ...
            echo "cmake, make, pkg-config, qt6-base-dev, libqt6gui6t64 | libqt6gui6, libqt6widgets6t64 | libqt6widgets6, qt6-tools-dev, qt6-svg-dev, libmupdf-dev, libharfbuzz-dev, libfreetype-dev, libjpeg-dev, libopenjp2-7-dev, libjbig2dec0-dev, libgumbo-dev, libmujs-dev"
            ;;
        rpm)
            ...
            echo "cmake, make, pkgconf, qt6-qtbase-devel, qt6-qttools-devel, qt6-qt6svg-devel, mupdf-devel, harfbuzz-devel, freetype-devel, libjpeg-turbo-devel, openjpeg2-devel, jbig2dec-devel, gumbo-parser-devel, mujs-devel, patchelf"
            ;;
        arch)
            # MuPDF for PDF rendering and export (static linking)
            # jbig2dec, gumbo-parser, mujs are MuPDF's optional dependencies
            echo "cmake, make, pkgconf, qt6-base, qt6-tools, qt6-svg, mupdf, harfbuzz, freetype2, libjpeg-turbo, openjpeg2, jbig2dec, gumbo-parser, mujs"
            ;;
        apk)
            # MuPDF for PDF rendering and export (static linking, needs dev packages for build)
            # jbig2dec, gumbo, mujs are MuPDF's optional dependencies
            echo "cmake, make, pkgconf, qt6-qtbase-dev, qt6-qttools-dev, qt6-qt6svg-dev, mupdf-dev, harfbuzz-dev, freetype-dev, libjpeg-turbo-dev, openjpeg-dev, jbig2dec-dev, gumbo-dev, mujs-dev"
            ;;
    esac
}
